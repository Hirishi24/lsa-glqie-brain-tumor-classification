...
def test_lesion_size_allocations():
    assert allocation_for_method("proposed_lsa_glqie", "small") == (3, 9)
    assert allocation_for_method("proposed_lsa_glqie", "medium") == (6, 6)
    assert allocation_for_method("proposed_lsa_glqie", "large") == (9, 3)
